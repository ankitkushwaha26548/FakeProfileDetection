...
const App = () => (
  <BrowserRouter>
    <Routes>
      ...
      <Route path="/admin/behavior" element={<AdminRoute><BehaviorAnalysis /></AdminRoute>} />
      <Route path="/admin/ip-monitoring" element={<AdminRoute><IPMonitoring /></AdminRoute>} />
      <Route path="/admin/risk" element={<AdminRoute><RiskScoring /></AdminRoute>} />
      <Route path="/admin/lookup" element={<AdminRoute><QuickLookup /></AdminRoute>} />
